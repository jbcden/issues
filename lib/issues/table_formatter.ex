defmodule Issues.TableFormatter do
  ...
  and those column are extracted and printed from the rows.0
  ...
  of column. The `headers` parameter contains the
  ...
  @doc """
  Generate the line that foes below the column headings. It is a string of
